...
public class NetworkSimulator {
    ...
    public void runSimulator() {
        ...
        System.out.println("costs in node0");
        for(int i=0;i<4;i++){
            for(int j=0;j<4;j++){
                System.out.print(n0.costs[i][j]);
            }
            System.out.println();
        }
        System.out.println("route:");
        for(int i=0;i<4;i++){
            System.out.print(n0.path[i]);
        }
        System.out.println("costs in node1");
        for(int i=0;i<4;i++){
            for(int j=0;j<4;j++){
                System.out.print(n1.costs[i][j]);
            }
            System.out.println();
        }
        System.out.println("route:");
        for(int i=0;i<4;i++){
            System.out.print(n1.path[i]);
        }
        System.out.println("costs in node2");
        for(int i=0;i<4;i++){
            for(int j=0;j<4;j++){
                System.out.print(n2.costs[i][j]);
            }
            System.out.println();
        }
        System.out.println("route:");
        for(int i=0;i<4;i++){
            System.out.print(n2.path[i]);
        }
        System.out.println("costs in node3");
        for(int i=0;i<4;i++){
            for(int j=0;j<4;j++){
                System.out.print(n3.costs[i][j]);
            }
            System.out.println();
        }
        System.out.println("route:");
        for(int i=0;i<4;i++){
            System.out.print(n3.path[i]);
        }
    }
