...
public class StudentNetworkSimulator extends NetworkSimulator
{
    ...
    protected void bInit()
    {
        ...
        rws = new int[WindowSize]; // Initialize the RWS window size
    ...
    protected void Simulation_done()
    {
      ...
      // Calculate the average RTT.
        ...
        System.out.println("Number of retransmissions by A:" + (int)retransmitA);
        System.out.println("Number of data packets delivered to layer 5 at B:" + maxMessages);
        System.out.println("Number of ACK packets sent by B:" + (int)ackB);
        System.out.println("Number of corrupted packets:" + (int)corrupted);
